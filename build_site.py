...
/* 文章正文样式 */
.article-body{font-size:15px;line-height:1.85;color:var(--text);max-width:780px}
...
.article-body code{background:var(--bg-2);padding:2px 6px;border-radius:4px;
  ...
  color:var(--accent)}
.article-body pre{background:var(--bg-2);border:1px solid var(--line);border-radius:6px;
