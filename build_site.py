...
:root{
  ...
  --accent:#f2762e;--accent-2:#fb923c;--accent-soft:#35241f;--accent-text:#ffb38f;
...
[data-theme="light"]{
  --bg:#f8fafc;--bg-2:#eef2ff;--card:#fff;--card-2:#f8fafc;
  --line:#e2e8f0;--line-2:#cbd5e1;
  --text:#1e293b;--text-2:#64748b;--text-3:#94a3b8;
  --brand:#6366f1;--brand-2:#4f46e5;--brand-soft:#eef2ff;--navy:#6366f1;
  --accent:#f2762e;--accent-2:#f97316;--accent-soft:#fff1e6;--accent-text:#b54708;
...
/* ---------- 顶栏 ---------- */
header{position:sticky;top:0;z-index:60;background:var(--bg-2);
...
/* ---------- 页脚 ---------- */
footer{background:#0d1b33;color:#94a3b8;padding:38px 20px 26px;font-size:13px;margin-top:auto}
...
.btn-ghost{background:rgba(148,163,184,.08);color:var(--text);border-color:var(--line-2)}
...
.pill{display:inline-flex;align-items:center;gap:7px;background:var(--accent-soft);
  border:1px solid transparent;color:var(--accent-text);
...
(function(){{
  ...
  if(t)t.addEventListener("click",function(){{
    var r=document.documentElement,d=r.getAttribute("data-theme")==="light";
...
<main>
  <section style="padding:64px 20px 36px;text-align:center;
    ...
    radial-gradient(ellipse 60% 40% at 80% 50%,rgba(6,182,212,.1) 0%,transparent 50%)">
