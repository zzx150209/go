...
:root{
  ...
  --brand:#c0392b;--brand-2:#a93226;--brand-soft:#fdf0ee;--navy:#2b3a67;
...
/* ---------- 页脚 ---------- */
footer{background:#1b1b26;color:#8b8b9a;padding:38px 20px 26px;font-size:13px;margin-top:auto}
.fwrap{max-width:var(--maxw);margin:0 auto;display:grid;grid-template-columns:1.5fr 1fr 1fr 1fr;gap:32px}
.fbrand b{display:block;color:#e8e8f0;font-size:15px;font-weight:700;margin-bottom:6px}
.fbrand p{margin:0;font-size:12.5px;line-height:1.7;opacity:.75}
.fcol h5{margin:0 0 10px;font-size:13px;color:#c9c9d6;font-weight:600}
...
.fbottom{max-width:var(--maxw);margin:26px auto 0;padding-top:18px;
  border-top:1px solid #2e2e3d;font-size:11.5px;opacity:.6;line-height:1.7}
...
.code{background:#1b1b26;border-radius:var(--radius-sm);padding:16px 18px;overflow-x:auto;
  ...
  color:#c9d1d9;border:1px solid #2e2e3d;white-space:pre}
